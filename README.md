...
**Adapter**: UDP transport abstraction
...
**AddressState**: External address and reachability management
...
- Auto-establishes bindings from adapter events
...
- Lives on Adapter for transport-level correlation
...
**Layer**: Single-stack protocol coordinator (IPv4 or IPv6)
- Orchestrates Adapter, AddressState, BindingCache, Coordinators
